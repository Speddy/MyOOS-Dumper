...
class CodePointString extends AbstractUnicodeString
{
    ...
    public function splice(string $replacement, int $start = 0, int $length = null)
    {
        ...
        $str = clone $this;
        $start = $start ? \strlen(\mb_substr((string) $this->string, 0, $start, 'UTF-8')) : 0;
    ...
    public function split(string $delimiter, int $limit = null, int $flags = null) : array
    {
        ...
        $str = clone $this;
        $chunks = $this->ignoreCase ? \preg_split('{' . \preg_quote($delimiter) . '}iuD', (string) $this->string, $limit) : \explode($delimiter, (string) $this->string, $limit);
